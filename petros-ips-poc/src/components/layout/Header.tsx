  ...
  return (
    <header role="banner" className="border-b border-border shrink-0">
      ...
      <div className="flex items-center h-12 px-3 sm:px-4 gap-2 bg-white">
        ...
        <span data-poc-badge className="hidden sm:inline-flex items-center text-caption font-semibold tracking-wider uppercase text-amber bg-amber/10 border border-amber/30 px-2 py-0.5 rounded shrink-0">
          POC
        </span>
